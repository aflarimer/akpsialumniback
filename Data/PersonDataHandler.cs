    ...
    public class PersonDataHandler : IPersonDataHandler
    {
        ...
        public PersonDataHandler() {
         ...
         public List<Person> Select() {
            ...
            string sql = "SELECT p.id, first_name, last_name, major, minor, pledge_class, graduating_semester, grad_school, grad_school_name, employed, position, company, city, email, phone, linkedIn, lat, lng FROM cities c right join person p on c.name = p.city order by last_name asc";            
            db.Open();
